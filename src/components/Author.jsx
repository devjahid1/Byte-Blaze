...
const Author = () => {
    ...
    const {name, username, github_username,twitter_username, website_url, profile_image} = blog.user
    return (
        <div>
	...
	<div className="space-y-4 text-center divide-y dark:divide-gray-300">
		<div className="my-2 space-y-1">
			...
			<p className="px-5 text-xs sm:text-base dark:text-gray-600">{username}</p>
		</div>
		<div className="flex justify-center pt-2 space-x-4 align-center">
			<a target="_blank" href={`https://github.com/${github_username}`} aria-label="GitHub" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
			...
			<a rel="noopener noreferrer" href={twitter_username} aria-label="Twitter" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
